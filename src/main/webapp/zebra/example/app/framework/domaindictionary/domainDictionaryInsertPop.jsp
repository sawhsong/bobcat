...
<div id="divDataArea" class="areaContainerPopup">
	<table class="tblEdit">
		...
		<tr>
			...
			<td class="tdEdit">
				<input type="text" id="domainName" name="domainName" class="txtEn" checkName="<tag:msg key="fwk.domaindictionary.header.name"/>" mandatory/>
			</td>
			<th class="thEdit mandatory"><tag:msg key="fwk.domaindictionary.header.nameAbbrev"/></th>
			<td class="tdEdit">
				<input type="text" id="nameAbbreviation" name="nameAbbreviation" class="txtEn" checkName="<tag:msg key="fwk.domaindictionary.header.nameAbbrev"/>" mandatory/>
			</td>
		</tr>
		<tr>
			<th class="thEdit mandatory"><tag:msg key="fwk.domaindictionary.header.dataType"/></th>
			<td class="tdEdit">
				<tag:select id="dataType" name="dataType" codeType="DOMAIN_DATA_TYPE" options="mandatory" source="framework"/>
			</td>
			<th class="thEdit"><tag:msg key="fwk.domaindictionary.header.dataLength"/></th>
			<td class="tdEdit">
				<tag:select id="dataLength" name="dataLength" codeType="DOMAIN_DATA_LENGTH" caption="==Select==" source="framework"/>
			</td>
		</tr>
		<tr>
			<th class="thEdit"><tag:msg key="fwk.domaindictionary.header.dataPrecision"/></th>
			<td class="tdEdit">
				<tag:select id="dataPrecision" name="dataPrecision" codeType="DOMAIN_DATA_PRECISION" caption="==Select==" source="framework"/>
			</td>
			<th class="thEdit"><tag:msg key="fwk.domaindictionary.header.dataScale"/></th>
			<td class="tdEdit">
				<tag:select id="dataScale" name="dataScale" codeType="DOMAIN_DATA_SCALE" caption="==Select==" source="framework"/>
			</td>
		</tr>
		<tr>
