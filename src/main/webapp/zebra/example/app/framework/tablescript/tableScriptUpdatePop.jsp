...
<div id="divInformArea" class="areaContainerPopup">
	<table class="tblEdit">
		...
		<tr>
			...
			<td class="tdEdit">
				<ui:text name="tableName" id="tableName" value="<%=tableName%>" className="defClass" style="text-transform:uppercase" checkName="fwk.tablescript.header.tableName" options="mandatory" maxlength="30"/>
			</td>
