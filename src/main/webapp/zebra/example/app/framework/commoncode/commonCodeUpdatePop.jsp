...
$(function() {
	...
	$(window).load(function() {
		parent.popup.setHeader("<tag:msg key="fwk.commoncode.header.popupHeaderEdit"/>");
...
<div id="divInformArea" class="areaContainerPopup">
	<table class="tblEdit">
		...
		<tr>
			...
			<td class="tdEdit">
				<input type="text" id="codeTypeMaster" name="codeTypeMaster" value="<%=resultDataSet.getValue(masterRow, "CODE_TYPE")%>" class="txtEn" style="text-transform:uppercase;" checkName="<tag:msg key="fwk.commoncode.header.codeType"/>" mandatory/>
			</td>
			<th class="thEdit mandatory"><tag:msg key="fwk.commoncode.header.useYn"/></th>
			<td class="tdEdit">
				<tag:radio name="useYnMaster" codeType="SIMPLE_YN" selectedValue="<%=isActive%>" source="framework"/>
			</td>
		</tr>
		<tr>
			<th class="thEdit mandatory"><tag:msg key="fwk.commoncode.header.descriptionEn"/></th>
			<td class="tdEdit">
				<input type="text" id="descriptionEnMaster" name="descriptionEnMaster" value="<%=resultDataSet.getValue(masterRow, "DESCRIPTION_EN")%>" class="txtEn" checkName="<tag:msg key="fwk.commoncode.header.descriptionEn"/>" mandatory/>
			</td>
			<th class="thEdit mandatory"><tag:msg key="fwk.commoncode.header.descriptionKo"/></th>
			<td class="tdEdit">
				<input type="text" id="descriptionKoMaster" name="descriptionKoMaster" value="<%=resultDataSet.getValue(masterRow, "DESCRIPTION_KO")%>" class="txtEn" checkName="<tag:msg key="fwk.commoncode.header.descriptionKo"/>" mandatory/>
			</td>
		</tr>
	</table>
</div>
...
%>
		<li id="liDummy<%=idSuffix%>" class="dummyDetail" index="<%=i%>">
			<table class="tblEdit">
				...
				<tr>
					<th id="thDragHander<%=idSuffix%>" index="<%=i%>" class="thEditCt dragHandler" title="<tag:msg key="fwk.commoncode.msg.drag"/>"><i id="iDragHandler<%=idSuffix%>" index="<%=i%>" class="fa fa-lg fa-sort"></i></th>
					<th class="thEdit mandatory"><tag:msg key="fwk.commoncode.header.commonCode"/></th>
					<td class="tdEdit">
						<input type="text" id="commonCodeDetail<%=idSuffix%>" name="commonCodeDetail<%=idSuffix%>" value="<%=resultDataSet.getValue(i, "COMMON_CODE")%>" class="txtEn" checkName="<tag:msg key="fwk.commoncode.header.commonCode"/>" mandatory/>
					</td>
					<th class="thEdit mandatory"><tag:msg key="fwk.commoncode.header.useYn"/></th>
					<td class="tdEdit">
						<tag:radio name="<%=rdoIsActiveName%>" codeType="SIMPLE_YN" selectedValue="<%=isActive%>" source="framework"/>
					</td>
					<th class="thEdit mandatory"><tag:msg key="fwk.commoncode.header.sortOrder"/></th>
					<td class="tdEdit">
						<input type="text" id="sortOrderDetail<%=idSuffix%>" name="sortOrderDetail<%=idSuffix%>" value="<%=resultDataSet.getValue(i, "SORT_ORDER")%>" class="txtEn" checkName="<tag:msg key="fwk.commoncode.header.sortOrder"/>" mandatory option="numeric"/>
					</td>
				</tr>
				<tr>
					<th id="thDeleteButton<%=idSuffix%>" index="<%=i%>" class="thEditCt deleteButton" title="<tag:msg key="fwk.commoncode.msg.delete"/>"><i id="iDeleteButton<%=idSuffix%>" index="<%=i%>" class="fa fa-lg fa-times"></i></th>
					<th class="thEdit mandatory"><tag:msg key="fwk.commoncode.header.descriptionEn"/></th>
					<td class="tdEdit">
						<input type="text" id="descriptionEnDetail<%=idSuffix%>" name="descriptionEnDetail<%=idSuffix%>" value="<%=resultDataSet.getValue(i, "DESCRIPTION_EN")%>" class="txtEn" checkName="<tag:msg key="fwk.commoncode.header.descriptionEn"/>" mandatory/>
					</td>
					<th class="thEdit mandatory"><tag:msg key="fwk.commoncode.header.descriptionKo"/></th>
					<td class="tdEdit" colspan="3">
						<input type="text" id="descriptionKoDetail<%=idSuffix%>" name="descriptionKoDetail<%=idSuffix%>" value="<%=resultDataSet.getValue(i, "DESCRIPTION_KO")%>" class="txtEn" checkName="<tag:msg key="fwk.commoncode.header.descriptionKo"/>" mandatory/>
					</td>
				</tr>
			</table>
		</li>
