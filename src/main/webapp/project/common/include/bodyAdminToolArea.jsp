...
<div id="divAdminToolContainer" class="adminToolContainer" style="overflow-y:hidden;">
	<table class="tblAdminTool">
		<caption><tag:msg key="page.com.adminTool"/></caption>
		<colgroup>
			<col width="20%"/>
			<col width="37%"/>
			<col width="*"/>
		...
		<tr>
			<td class="tdAdminToolRt" style="vertical-align:top;">
				<table class="tblDefault">
					...
					<tr>
						<th class="thDefault" style="padding:2px 2px 1px 0px;"><tag:msg key="page.com.loginUserNameAs"/></th>
					...
					<tr>
						<th class="thDefault" style="padding:1px 2px 1px 0px;"><tag:msg key="page.com.loginUserLoginIdAs"/></th>
			...
			<td class="tdAdminTool" style="vertical-align:top;">
				<table class="tblAdminToolGrid">
					...
					<thead>
						<tr>
							<th class="thAdminToolGrid"><tag:msg key="page.com.headerIncome"/></th>
							<th class="thAdminToolGrid"><tag:msg key="page.com.headerExpense"/></th>
							<th class="thAdminToolGrid"><tag:msg key="page.com.headerAsset"/></th>
						</tr>
					</thead>
					<tbody>
						<tr>
			...
			<td class="tdAdminTool" style="vertical-align:top;">
				<table class="tblAdminToolGrid" style="border-bottom:0px;">
					...
					<thead>
						<tr>
							<th class="thAdminToolGrid"><tag:msg key="page.com.headerRepayment"/></th>
							<th class="thAdminToolGrid"><tag:msg key="page.com.headerBorrowing"/></th>
							<th class="thAdminToolGrid"><tag:msg key="page.com.headerLending"/></th>
						</tr>
					</thead>
					<tbody>
						<tr>
				...
				<table class="tblAdminToolGrid">
					...
					<thead>
						<tr>
							<th class="thAdminToolGrid"><tag:msg key="page.com.headerVisaStatus"/></th>
							<th class="thAdminToolGrid"><tag:msg key="page.com.headerEmpCnt"/></th>
							<th class="thAdminToolGrid"><tag:msg key="page.com.headerWageCnt"/></th>
							<th class="thAdminToolGrid"><tag:msg key="page.com.headerGrossWage"/></th>
							<th class="thAdminToolGrid"><tag:msg key="page.com.headerTax"/></th>
							<th class="thAdminToolGrid"><tag:msg key="page.com.headerSuper"/></th>
							<th class="thAdminToolGrid"><tag:msg key="page.com.headerNetWage"/></th>
						</tr>
					</thead>
