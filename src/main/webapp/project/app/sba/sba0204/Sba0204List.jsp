...
<div id="divSearchCriteriaArea" class="areaContainer">
	<table class="tblSearch">
		...
		<tr>
			<th class="thSearch rt"><mc:msg key="sba0204.search.name"/></th>
			<td class="tdSearch"><ui:text name="userName"/></td>
			<th class="thSearch rt"><mc:msg key="sba0204.search.id"/></th>
...
%>
		...
		<tr>
			<th class="thSearch rt"><mc:msg key="sba0204.search.type"/></th>
			<td class="tdSearch"><ui:ccselect name="userType" codeType="USER_TYPE" caption="==Select=="/></td>
			<th class="thSearch rt"><mc:msg key="sba0204.search.status"/></th>
			<td class="tdSearch"><ui:ccselect name="userStatus" codeType="USER_STATUS" caption="==Select=="/></td>
			<th class="thSearch rt"><mc:msg key="sba0204.search.active"/></th>
	...
	<table id="tblGrid" class="tblGrid sort autosort">
		...
		<thead>
			<tr>
				...
				<th class="thGrid sortable:alphanumeric"><mc:msg key="sba0204.grid.orgName"/></th>
