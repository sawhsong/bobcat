...
<div id="divDataArea" class="areaContainerPopup">
	...
	<table class="tblEdit">
		...
		<tr>
			...
			<td class="tdEdit">
				<input type="text" id="userName" name="userName" value="<%=sysUser.getUserName()%>" class="txtEn" checkName="<tag:msg key="sba0204.header.userName"/>" mandatory/>
			</td>
		</tr>
		<tr>
			<th class="thEdit mandatory"><tag:msg key="sba0204.header.loginId"/></th>
			<td class="tdEdit">
				<input type="text" id="loginId" name="loginId" value="<%=sysUser.getLoginId()%>" class="txtEn" checkName="<tag:msg key="sba0204.header.loginId"/>" mandatory/>
			</td>
...
%>
		...
		<tr>
			...
			<td class="tdEdit">
				<input type="text" id="email" name="email" value="<%=sysUser.getEmail()%>" class="txtEn" checkName="<tag:msg key="sba0204.header.email"/>" mandatory option="email"/>
			</td>
		</tr>
		<tr>
