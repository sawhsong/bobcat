...
<div id="divSearchCriteriaArea" class="areaContainer">
	<table class="tblSearch">
		...
		<tr>
			<td class="tdSearch">
				<label for="orgCategory" class="lblEn hor mandatory"><mc:msg key="sba0410.search.orgCategory"/></label>
	...
	<table id="tblGrid" class="tblGrid sort autosort">
		...
		<thead>
			<tr>
				...
				<th class="thGrid sortable:alphanumeric"><mc:msg key="sba0410.grid.repaymentType"/></th>
				<th class="thGrid"><mc:msg key="sba0410.grid.isApplyGst"/></th>
				<th class="thGrid"><mc:msg key="sba0410.grid.gstPercentage"/></th>
				<th class="thGrid"><mc:msg key="sba0410.grid.accountCode"/></th>
				<th class="thGrid"><mc:msg key="sba0410.grid.insertDate"/></th>
				<th class="thGrid"><mc:msg key="sba0410.grid.updateDate"/></th>
			</tr>
		</thead>
