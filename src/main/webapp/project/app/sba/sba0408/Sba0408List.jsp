...
$(function() {
	...
	renderDataGridTable = function(result) {
		...
		if (ds.getRowCnt() > 0) {
			for (var i=0; i<ds.getRowCnt(); i++) {
				...
				html += "<tr>";
				html += "<td class=\"tdGridCt\"><input type=\"checkbox\" id=\"chkToAssign\" name=\"chkToAssign\" class=\"chkEn inTblGrid\" "+checkString+" value=\""+ds.getValue(i, "ASSET_TYPE_ID")+"_"+ds.getValue(i, "ASSET_TYPE_CODE")+"\"/></td>";
				html += "<td class=\"tdGrid\"><a onclick=\"getDetail('"+ds.getValue(i, "ASSET_TYPE_ID")+"', '"+ds.getValue(i, "ASSET_TYPE_CODE")+"')\" class=\"aEn\">"+ds.getValue(i, "ASSET_TYPE_NAME")+"</a>";
	...
	openPopup = function(param) {
		...
		if (param.mode == "Detail") {
			...
			header = "<tag:msg key="sba0408.header.popupHeaderDetail"/>";
		} else if (param.mode == "New" || param.mode == "Reply") {
			url = "/sba/0404/getInsert.do";
			header = "<tag:msg key="sba0408.header.popupHeaderEdit"/>";
...
<div id="divSearchCriteriaArea" class="areaContainer">
	<table class="tblSearch">
		...
		<tr>
			<td class="tdSearch">
				<label for="orgCategory" class="lblEn hor mandatory"><tag:msg key="sba0408.search.orgCategory"/></label>
	...
	<table id="tblGrid" class="tblGrid sort autosort">
		...
		<thead>
			<tr>
				...
				<th class="thGrid sortable:alphanumeric"><tag:msg key="sba0408.grid.assetType"/></th>
				<th class="thGrid"><tag:msg key="sba0408.grid.isApplyGst"/></th>
				<th class="thGrid"><tag:msg key="sba0408.grid.gstPercentage"/></th>
				<th class="thGrid"><tag:msg key="sba0408.grid.accountCode"/></th>
				<th class="thGrid"><tag:msg key="sba0408.grid.insertDate"/></th>
				<th class="thGrid"><tag:msg key="sba0408.grid.updateDate"/></th>
			</tr>
		</thead>
