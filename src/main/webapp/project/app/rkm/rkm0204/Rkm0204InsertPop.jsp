...
<div id="divDataArea" class="areaContainerPopup">
	<table class="tblEdit">
		...
		<tr>
			<th class="thEdit mandatory"><tag:msg key="rkm0204.header.writerName"/></th>
			<td class="tdEdit">
				<input type="text" id="writerName" name="writerName" class="txtEn" value="<%=sysUser.getUserName()%>" checkName="<tag:msg key="rkm0204.header.writerName"/>" mandatory/>
			</td>
			<th class="thEdit mandatory"><tag:msg key="rkm0204.header.writerEmail"/></th>
			<td class="tdEdit">
				<input type="text" id="writerEmail" name="writerEmail" class="txtEn" value="<%=sysUser.getEmail()%>" checkName="<tag:msg key="rkm0204.header.writerEmail"/>" option="email" mandatory/>
			</td>
		</tr>
		<tr>
			<th class="thEditRt mandatory"><tag:msg key="rkm0204.header.articleSubject"/></th>
			<td class="tdEdit" colspan="3">
				<input type="text" id="articleSubject" name="articleSubject" class="txtEn" checkName="<tag:msg key="rkm0204.header.articleSubject"/>" mandatory/>
			</td>
		</tr>
		<tr>
