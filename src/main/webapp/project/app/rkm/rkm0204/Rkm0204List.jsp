...
<div id="divInformArea" class="areaContainer">
	<table class="tblDataEntry">
		...
		<tr>
			...
			<td class="tdDataEntry"><ui:text name="deGrossSales" className="rt numeric" checkName="rkm0204.de.grossSales" options="mandatory" option="numeric"/></td>
			<td class="tdDataEntry"><ui:text name="deGst" className="rt numeric" checkName="rkm0204.de.gst" options="mandatory" option="numeric"/></td>
			<td class="tdDataEntry"><ui:text name="deNetSales" className="rt numeric" options="mandatory" status="display"/></td>
			<td class="tdDataEntry"><ui:text name="deRemark"/></td>
			<td class="tdDataEntryCt"><ui:icon id="icnDataEntryAction" className="fa-tasks fa-lg" script="doDataEntryAction(this)"/></td>
		</tr>
	</table>
</div>
<%/************************************************************************************************
