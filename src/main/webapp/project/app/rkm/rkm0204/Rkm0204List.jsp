...
$(function() {
	...
	renderDataGridTable = function(result) {
		...
		totHtml += "<td class=\"tdGridCt\"><tag:msg key="rkm0204.grid.incomeTotal"/></td>";
	...
	openPopup = function(param) {
		...
		if (param.mode == "Detail") {
			...
			header = "<tag:msg key="rkm0204.header.popupHeaderDetail"/>";
		} else if (param.mode == "New" || param.mode == "Reply") {
			url = "/rkm/0204/getInsert.do";
			header = "<tag:msg key="rkm0204.header.popupHeaderEdit"/>";
...
<div id="divSearchCriteriaArea" class="areaContainer">
	<table class="tblSearch">
		...
		<tr>
			<td class="tdSearch">
				<label for="financialYear" class="lblEn hor mandatory"><tag:msg key="rkm0204.search.financialYear"/></label>
				<div style="float:left;padding-right:4px;">
					<tag:deSelect id="financialYear" name="financialYear" codeType="FinancialYear" selectedValue="<%=selectedFinancialYear%>"/>
				</div>
			</td>
			<td class="tdSearch">
				<label for="quarterName" class="lblEn hor mandatory"><tag:msg key="rkm0204.search.quarter"/></label>
				<div style="float:left;padding-right:4px;">
...
<div id="divInformArea" class="areaContainer">
	<table class="tblDataEntry">
		...
		<tr>
			<th class="thDataEntryCt mandatory"><tag:msg key="rkm0204.de.date"/></th>
			<th class="thDataEntryCt mandatory"><tag:msg key="rkm0204.de.grossSales"/></th>
			<th class="thDataEntryCt mandatory"><tag:msg key="rkm0204.de.gst"/></th>
			<th class="thDataEntryCt"><tag:msg key="rkm0204.de.netSales"/></th>
			<th class="thDataEntryCt mandatory"><tag:msg key="rkm0204.de.remark"/></th>
			<th class="thDataEntryCt"><tag:msg key="rkm0204.de.action"/></th>
		</tr>
		<tr>
			<td class="tdDataEntryCt">
				<div style="display:inline-block;">
					<input type="text" id="deDate" name="deDate" class="txtEnCt hor" style="width:100px" checkName="<tag:msg key="rkm0204.de.date"/>" mandatory option="date"/>
					<i id="icnDataEntryDate" class="fa fa-calendar icnEn hor"></i>
				</div>
			</td>
			<td class="tdDataEntry">
				<input type="text" id="deGrossSales" name="deGrossSales" class="txtEnRt numeric" checkName="<tag:msg key="rkm0204.de.grossSales"/>" mandatory option="numeric"/>
			</td>
			<td class="tdDataEntry">
				<input type="text" id="deGst" name="deGst" class="txtEnRt numeric" checkName="<tag:msg key="rkm0204.de.gst"/>" mandatory option="numeric"/>
			</td>
			<td class="tdDataEntry">
	...
	<table id="tblGrid" class="tblGrid sort autosort">
		...
		<thead>
			<tr>
				...
				<th class="thGrid sortable:date"><tag:msg key="rkm0204.grid.date"/></th>
				<th class="thGrid"><tag:msg key="rkm0204.grid.grossSales"/></th>
				<th class="thGrid"><tag:msg key="rkm0204.grid.gst"/></th>
				<th class="thGrid"><tag:msg key="rkm0204.grid.netSales"/></th>
				<th class="thGrid"><tag:msg key="rkm0204.grid.remark"/></th>
				<th class="thGrid"><tag:msg key="rkm0204.grid.isCompleted"/></th>
				<th class="thGrid sortable:date"><tag:msg key="rkm0204.grid.insertDate"/></th>
				<th class="thGrid sortable:date"><tag:msg key="rkm0204.grid.updateDate"/></th>
