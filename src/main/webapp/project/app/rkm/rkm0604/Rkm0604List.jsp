...
<div id="divSearchCriteriaArea" class="areaContainer">
	<table class="tblSearch">
		...
		<tr>
			<td class="tdSearch">
				<label for="financialYear" class="lblEn hor mandatory"><mc:msg key="rkm0604.search.financialYear"/></label>
				<div style="float:left;padding-right:4px;">
					<ui:deSelect name="financialYear" codeType="FinancialYear" selectedValue="<%=selectedFinancialYear%>"/>
				</div>
			</td>
			<td class="tdSearch">
				<label for="quarterName" class="lblEn hor mandatory"><mc:msg key="rkm0604.search.quarter"/></label>
				<div style="float:left;padding-right:4px;">
...
<div id="divInformArea" class="areaContainer">
	<table class="tblDataEntry">
		...
		<tr>
			...
			<th class="thDataEntry mandatory"><mc:msg key="rkm0604.de.startDate"/></th>
			<th class="thDataEntry mandatory"><mc:msg key="rkm0604.de.endDate"/></th>
			<th class="thDataEntry"><mc:msg key="rkm0604.de.fileAttach"/></th>
			<th class="thDataEntry"><mc:msg key="rkm0604.de.remark"/></th>
			<th class="thDataEntry"><mc:msg key="rkm0604.de.action"/></th>
		</tr>
		<tr>
			<td class="tdDataEntry Ct">
				<div style="display:inline-block;">
					<ui:text name="deDate" className="hor" style="width:100px" checkName="rkm0604.de.date" options="mandatory" option="date"/>
			...
			<td class="tdDataEntry Ct">
				<div style="display:inline-block;">
					<ui:text name="deStartDate" className="hor" style="width:100px" checkName="rkm0604.de.startDate" options="mandatory" option="date"/>
					<ui:icon id="icnDataEntryStartDate" className="fa-calendar hor"/>
				</div>
			</td>
			<td class="tdDataEntry Ct">
				<div style="display:inline-block;">
					<ui:text name="deEndDate" className="hor" style="width:100px" checkName="rkm0604.de.endDate" options="mandatory" option="date"/>
	...
	<table id="tblGrid" class="tblGrid sort autosort">
		...
		<thead>
			<tr>
				...
				<th class="thGrid"><mc:msg key="rkm0604.grid.date"/></th>
				<th class="thGrid"><mc:msg key="rkm0604.grid.borrowingType"/></th>
				<th class="thGrid"><mc:msg key="rkm0604.grid.principalAmt"/></th>
				<th class="thGrid"><mc:msg key="rkm0604.grid.interestPercentage"/></th>
				<th class="thGrid"><mc:msg key="rkm0604.grid.startDate"/></th>
				<th class="thGrid"><mc:msg key="rkm0604.grid.endDate"/></th>
