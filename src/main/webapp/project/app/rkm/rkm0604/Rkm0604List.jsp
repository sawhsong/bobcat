...
<div id="divInformArea" class="areaContainer">
	<table class="tblDataEntry">
		...
		<tr>
			...
			<td class="tdDataEntry Ct">
				<div style="display:inline-block;">
					<ui:text name="deStartDate" className="ct hor" style="width:100px" checkName="rkm0604.de.startDate" options="mandatory" option="date"/>
					<ui:icon id="icnDataEntryStartDate" className="fa-calendar hor"/>
				</div>
			</td>
			<td class="tdDataEntry Ct">
				<div style="display:inline-block;">
					<ui:text name="deEndDate" className="ct hor" style="width:100px" checkName="rkm0604.de.endDate" options="mandatory" option="date"/>
