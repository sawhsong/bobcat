...
<%
	...
	String paramIncomeType = requestDataSet.getValue("incomeType");
	...
	String selectedIncomeType = CommonUtil.nvl(paramIncomeType);
%>
<%/************************************************************************************************
* HTML
************************************************************************************************/%>
...
$(function() {
	...
	renderDataGridTable = function(result) {
		...
		if (ds.getRowCnt() > 0) {
			for (var i=0; i<ds.getRowCnt(); i++) {
				...
				html += "<td class=\"tdGridCt\"><a onclick=\"getDetail('"+ds.getValue(i, "INCOME_ID")+"')\" class=\"aEn\">"+ds.getValue(i, "INCOME_DATE")+"</a></td>";
		...
		totHtml += "<td class=\"tdGridCt\"><tag:msg key="rkm0206.grid.incomeTotal"/></td>";
	...
	openPopup = function(param) {
		...
		if (param.mode == "Detail") {
			...
			header = "<tag:msg key="rkm0206.header.popupHeaderDetail"/>";
		} else if (param.mode == "New" || param.mode == "Reply") {
			url = "/rkm/0206/getInsert.do";
			header = "<tag:msg key="rkm0206.header.popupHeaderEdit"/>";
...
<div id="divSearchCriteriaArea" class="areaContainer">
	<table class="tblSearch">
		...
		<tr>
			<td class="tdSearch">
				<label for="financialYear" class="lblEn hor mandatory"><tag:msg key="rkm0206.search.financialYear"/></label>
				<div style="float:left;padding-right:4px;">
					<tag:deSelect id="financialYear" name="financialYear" codeType="FinancialYear" selectedValue="<%=selectedFinancialYear%>"/>
				</div>
			</td>
			<td class="tdSearch">
				<label for="quarterName" class="lblEn hor mandatory"><tag:msg key="rkm0206.search.quarter"/></label>
				<div style="float:left;padding-right:4px;">
					<tag:select id="quarterName" name="quarterName" codeType="QUARTER_NAME" selectedValue="<%=selectedQuarterName%>"/>
				</div>
			</td>
			<td class="tdSearch">
				<label for="incomeType" class="lblEn hor mandatory"><tag:msg key="rkm0206.search.incomeType"/></label>
				<div style="float:left;padding-right:4px;">
					<tag:deSelect id="incomeType" name="incomeType" codeType="IncomeType" orgCategory="<%=orgCategory%>" selectedValue="<%=selectedIncomeType%>"/>
				</div>
			</td>
		</tr>
	</table>
...
<div id="divInformArea" class="areaContainer">
	<table class="tblDataEntry">
		...
		<tr>
			<th class="thDataEntryCt mandatory"><tag:msg key="rkm0206.de.date"/></th>
			<th class="thDataEntryCt mandatory"><tag:msg key="rkm0206.de.grossSales"/></th>
			<th class="thDataEntryCt mandatory"><tag:msg key="rkm0206.de.gst"/></th>
			<th class="thDataEntryCt"><tag:msg key="rkm0206.de.netSales"/></th>
			<th class="thDataEntryCt mandatory"><tag:msg key="rkm0206.de.incomeType"/></th>
			<th class="thDataEntryCt mandatory"><tag:msg key="rkm0206.de.remark"/></th>
			<th class="thDataEntryCt"><tag:msg key="rkm0206.de.action"/></th>
		</tr>
		<tr>
			<td class="tdDataEntryCt">
				<div style="display:inline-block;">
					<input type="text" id="deDate" name="deDate" class="txtEnCt hor" style="width:100px" checkName="<tag:msg key="rkm0206.de.date"/>" mandatory option="date"/>
					<i id="icnDataEntryDate" class="fa fa-calendar icnEn hor"></i>
				</div>
			</td>
			<td class="tdDataEntry">
				<input type="text" id="deGrossSales" name="deGrossSales" class="txtEnRt numeric" checkName="<tag:msg key="rkm0206.de.grossSales"/>" mandatory option="numeric"/>
			</td>
			<td class="tdDataEntry">
				<input type="text" id="deGst" name="deGst" class="txtEnRt numeric" checkName="<tag:msg key="rkm0206.de.gst"/>" mandatory option="numeric"/>
			</td>
			<td class="tdDataEntry">
				<input type="text" id="deNetSales" name="deNetSales" class="txtDplRt numeric" disabled/>
			</td>
			<td class="tdDataEntryCt">
				<tag:deSelect id="deIncomeType" name="deIncomeType" codeType="IncomeType" orgCategory="<%=orgCategory%>" options="mandatory"/>
			</td>
			<td class="tdDataEntry">
	...
	<table id="tblGrid" class="tblGrid sort autosort">
		...
		<thead>
			<tr>
				...
				<th class="thGrid sortable:date"><tag:msg key="rkm0206.grid.date"/></th>
				<th class="thGrid"><tag:msg key="rkm0206.grid.grossSales"/></th>
				<th class="thGrid"><tag:msg key="rkm0206.grid.gst"/></th>
				<th class="thGrid"><tag:msg key="rkm0206.grid.netSales"/></th>
				<th class="thGrid"><tag:msg key="rkm0206.grid.remark"/></th>
				<th class="thGrid"><tag:msg key="rkm0206.grid.isCompleted"/></th>
				<th class="thGrid sortable:date"><tag:msg key="rkm0206.grid.insertDate"/></th>
				<th class="thGrid sortable:date"><tag:msg key="rkm0206.grid.updateDate"/></th>
