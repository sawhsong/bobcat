...
<div id="divSearchCriteriaArea" class="areaContainer">
	<table class="tblSearch">
		...
		<tr>
			<td class="tdSearch">
				<label for="financialYear" class="lblEn hor mandatory"><mc:msg key="rkm0804.search.financialYear"/></label>
				<div style="float:left;padding-right:4px;">
					<ui:deSelect name="financialYear" codeType="FinancialYear" selectedValue="<%=selectedFinancialYear%>"/>
				</div>
			</td>
			<td class="tdSearch">
				<label for="quarterName" class="lblEn hor mandatory"><mc:msg key="rkm0804.search.quarter"/></label>
				<div style="float:left;padding-right:4px;">
					<ui:ccselect name="quarterName" codeType="QUARTER_NAME" selectedValue="<%=selectedQuarterName%>"/>
				</div>
			</td>
			<td class="tdSearch">
				<label for="surname" class="lblEn hor"><mc:msg key="rkm0804.search.surname"/></label>
				<ui:text name="surname" className="hor" style="width:200px;"/>
			</td>
			<td class="tdSearch">
				<label for="givenName" class="lblEn hor"><mc:msg key="rkm0804.search.givenName"/></label>
				<ui:text name="givenName" className="hor" style="width:200px;"/>
			</td>
			<td class="tdSearch">
				<label for="visaType" class="lblEn hor"><mc:msg key="rkm0804.search.visaType"/></label>
				<div style="float:left;padding-right:4px;">
		...
		<table id="tblEmpList" class="tblGrid sort autosort">
			...
			<thead>
				<tr>
					...
					<th class="thGrid"><mc:msg key="rkm0804.grid.super"/></th>
				</tr>
			</thead>
