...
$(function() {
	...
	$(window).load(function() {
		parent.popup.setHeader("<tag:msg key="rkm0202.title.popupTitleEdit"/>");
	});
});
</script>
</head>
...
<div id="divDataArea" class="areaContainerPopup">
	<table class="tblEdit">
		...
		<tr>
			<th class="thEditRt mandatory"><tag:msg key="rkm0202.header.writerName"/></th>
			<td class="tdEdit">
				<input type="text" id="writerName" name="writerName" class="txtEn" value="<%=sysBoard.getWriterName()%>" checkName="<tag:msg key="rkm0202.header.writerName"/>" mandatory/>
			</td>
			<th class="thEditRt mandatory"><tag:msg key="rkm0202.header.writerEmail"/></th>
			<td class="tdEdit">
				<input type="text" id="writerEmail" name="writerEmail" class="txtEn" value="<%=sysBoard.getWriterEmail()%>" checkName="<tag:msg key="rkm0202.header.writerEmail"/>" option="email" mandatory/>
			</td>
		</tr>
		<tr>
			<th class="thEditRt mandatory"><tag:msg key="rkm0202.header.articleSubject"/></th>
			<td class="tdEdit" colspan="3">
				<input type="text" id="articleSubject" name="articleSubject" class="txtEn" value="<%=sysBoard.getArticleSubject()%>" checkName="<tag:msg key="rkm0202.header.articleSubject"/>" mandatory/>
			</td>
		</tr>
		<tr>
