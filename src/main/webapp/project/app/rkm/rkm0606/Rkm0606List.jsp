...
<%
	...
	String paramLendingType = requestDataSet.getValue("lendingType");
	...
	String selectedLendingType = CommonUtil.nvl(paramLendingType);
%>
<%/************************************************************************************************
* HTML
************************************************************************************************/%>
...
$(function() {
	...
	renderDataGridTable = function(result) {
		...
		totHtml += "<td class=\"tdGridCt\"></td>";
		totHtml += "<td class=\"tdGridCt\"><tag:msg key="rkm0606.grid.total"/></td>";
	...
	openPopup = function(param) {
		...
		if (param.mode == "Detail") {
			...
			header = "<tag:msg key="rkm0606.header.popupHeaderDetail"/>";
		} else if (param.mode == "New" || param.mode == "Reply") {
			url = "/rkm/0606/getInsert.do";
			header = "<tag:msg key="rkm0606.header.popupHeaderEdit"/>";
...
<div id="divSearchCriteriaArea" class="areaContainer">
	<table class="tblSearch">
		...
		<tr>
			<td class="tdSearch">
				<label for="financialYear" class="lblEn hor mandatory"><tag:msg key="rkm0606.search.financialYear"/></label>
				<div style="float:left;padding-right:4px;">
					<tag:deSelect id="financialYear" name="financialYear" codeType="FinancialYear" selectedValue="<%=selectedFinancialYear%>"/>
				</div>
			</td>
			<td class="tdSearch">
				<label for="quarterName" class="lblEn hor mandatory"><tag:msg key="rkm0606.search.quarter"/></label>
				<div style="float:left;padding-right:4px;">
					<tag:select id="quarterName" name="quarterName" codeType="QUARTER_NAME" selectedValue="<%=selectedQuarterName%>"/>
				</div>
			</td>
			<td class="tdSearch">
				<label for="lendingType" class="lblEn hor mandatory"><tag:msg key="rkm0606.search.lendingType"/></label>
				<div style="float:left;padding-right:4px;">
					<tag:deSelect id="lendingType" name="lendingType" codeType="LendingType" caption="==Select==" orgCategory="<%=orgCategory%>" selectedValue="<%=selectedLendingType%>"/>
				</div>
			</td>
		</tr>
	</table>
...
<div id="divInformArea" class="areaContainer">
	<table class="tblDataEntry">
		...
		<tr>
			<th class="thDataEntryCt mandatory"><tag:msg key="rkm0606.de.date"/></th>
			<th class="thDataEntryCt mandatory"><tag:msg key="rkm0606.de.lendingType"/></th>
			<th class="thDataEntryCt mandatory"><tag:msg key="rkm0606.de.lendingType"/></th>
			<th class="thDataEntryCt mandatory"><tag:msg key="rkm0606.de.principalAmt"/></th>
			<th class="thDataEntryCt mandatory"><tag:msg key="rkm0606.de.interestPercentage"/></th>
			<th class="thDataEntryCt mandatory"><tag:msg key="rkm0606.de.startDate"/></th>
			<th class="thDataEntryCt mandatory"><tag:msg key="rkm0606.de.endDate"/></th>
			<th class="thDataEntryCt"><tag:msg key="rkm0606.de.fileAttach"/></th>
			<th class="thDataEntryCt"><tag:msg key="rkm0606.de.remark"/></th>
			<th class="thDataEntryCt"><tag:msg key="rkm0606.de.action"/></th>
		</tr>
		<tr>
			<td class="tdDataEntryCt">
				<div style="display:inline-block;">
					<input type="text" id="deDate" name="deDate" class="txtEnCt hor" style="width:100px" checkName="<tag:msg key="rkm0606.de.date"/>" mandatory option="date"/>
					<i id="icnDataEntryDate" class="fa fa-calendar icnEn hor"></i>
				</div>
			</td>
			<td class="tdDataEntryCt">
				<tag:button id="btnDeLendingType" caption="rkm0606.de.lendingType" iconClass="fa-caret-down"/>
			</td>
			<td class="tdDataEntryCt">
				<tag:deSelect id="deLendingType" name="deLendingType" codeType="LendingType" caption="==Select==" orgCategory="<%=orgCategory%>" options="mandatory"/>
			</td>
			<td class="tdDataEntryCt">
				<input type="text" id="dePrincipalAmt" name="dePrincipalAmt" class="txtEnRt numeric" checkName="<tag:msg key="rkm0606.de.principalAmt"/>" mandatory option="numeric"/>
			</td>
			<td class="tdDataEntryCt">
				<input type="text" id="deInterestPercentage" name="deInterestPercentage" class="txtEnRt numeric" checkName="<tag:msg key="rkm0606.de.deInterestPercentage"/>" mandatory option="numeric"/>
			</td>
			<td class="tdDataEntryCt">
				<div style="display:inline-block;">
					<input type="text" id="deStartDate" name="deStartDate" class="txtEnCt hor" style="width:100px" checkName="<tag:msg key="rkm0606.de.startDate"/>" mandatory option="date"/>
					<i id="icnDataEntryStartDate" class="fa fa-calendar icnEn hor"></i>
				</div>
			</td>
			<td class="tdDataEntryCt">
				<div style="display:inline-block;">
					<input type="text" id="deEndDate" name="deEndDate" class="txtEnCt hor" style="width:100px" checkName="<tag:msg key="rkm0606.de.endDate"/>" mandatory option="date"/>
	...
	<table id="tblGrid" class="tblGrid sort autosort">
		...
		<thead>
			<tr>
				...
				<th class="thGrid sortable:date"><tag:msg key="rkm0606.grid.date"/></th>
				<th class="thGrid"><tag:msg key="rkm0606.grid.lendingType"/></th>
				<th class="thGrid"><tag:msg key="rkm0606.grid.principalAmt"/></th>
				<th class="thGrid"><tag:msg key="rkm0606.grid.interestPercentage"/></th>
				<th class="thGrid sortable:date"><tag:msg key="rkm0606.grid.startDate"/></th>
				<th class="thGrid sortable:date"><tag:msg key="rkm0606.grid.endDate"/></th>
				<th class="thGrid"><tag:msg key="rkm0606.grid.fileCnt"/></th>
				<th class="thGrid"><tag:msg key="rkm0606.grid.remark"/></th>
				<th class="thGrid"><tag:msg key="rkm0606.grid.isCompleted"/></th>
				<th class="thGrid sortable:date"><tag:msg key="rkm0606.grid.updateDate"/></th>
