...
<div id="divDataArea" class="areaContainer">
	<table class="tblEdit">
		...
		<tr>
			...
			<td class="tdEdit">
				<input type="text" id="writerName" name="writerName" class="txtEn" value="" checkName="<tag:msg key="sys0604.header.writerName"/>" mandatory/>
			</td>
			<th class="thEdit mandatory"><tag:msg key="sys0604.header.writerEmail"/></th>
			<td class="tdEdit">
				<input type="text" id="writerEmail" name="writerEmail" class="txtEn" value="" checkName="<tag:msg key="sys0604.header.writerEmail"/>" option="email" mandatory/>
			</td>
		</tr>
		<tr>
			<th class="thEdit mandatory"><tag:msg key="sys0604.header.articleSubject"/></th>
			<td class="tdEdit" colspan="3">
				<input type="text" id="articleSubject" name="articleSubject" class="txtEn" value="" checkName="<tag:msg key="sys0604.header.articleSubject"/>" mandatory/>
			</td>
		</tr>
		<tr>
