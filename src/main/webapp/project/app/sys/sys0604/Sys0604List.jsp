...
<div id="divSearchCriteriaArea" class="areaContainer">
	<table class="tblSearch">
		...
		<tr>
			<th class="thSearch rt"><mc:msg key="sys0604.search.name"/></th>
			<td class="tdSearch"><ui:text name="userName"/></td>
			<th class="thSearch rt"><mc:msg key="sys0604.search.id"/></th>
			<td class="tdSearch"><ui:text name="loginId" style="width:200px"/></td>
			<th class="thSearch rt"><mc:msg key="sys0604.search.auth"/></th>
			<td class="tdSearch">
...
%>
		...
		<tr>
			<th class="thSearch rt"><mc:msg key="sys0604.search.type"/></th>
			<td class="tdSearch"><ui:ccselect name="userType" codeType="USER_TYPE" caption="==Select=="/></td>
			<th class="thSearch rt"><mc:msg key="sys0604.search.status"/></th>
			<td class="tdSearch"><ui:ccselect name="userStatus" codeType="USER_STATUS" caption="==Select=="/></td>
			<th class="thSearch rt"><mc:msg key="sys0604.search.active"/></th>
	...
	<table id="tblGrid" class="tblGrid sort autosort">
		...
		<thead>
			<tr>
				...
				<th class="thGrid sortable:alphanumeric"><mc:msg key="sys0604.grid.userName"/></th>
				<th class="thGrid sortable:alphanumeric"><mc:msg key="sys0604.grid.loginId"/></th>
				<th class="thGrid sortable:alphanumeric"><mc:msg key="sys0604.grid.orgName"/></th>
				<th class="thGrid sortable:alphanumeric"><mc:msg key="sys0604.grid.authGroup"/></th>
				<th class="thGrid sortable:alphanumeric"><mc:msg key="sys0604.grid.type"/></th>
				<th class="thGrid sortable:alphanumeric"><mc:msg key="sys0604.grid.status"/></th>
				<th class="thGrid"><mc:msg key="sys0604.grid.email"/></th>
				<th class="thGrid"><mc:msg key="sys0604.grid.active"/></th>
