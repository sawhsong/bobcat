<%/************************************************************************************************
* Description - Sys0604 - User Management
...
<div id="divDataArea" class="areaContainerPopup">
	...
	<table class="tblEdit">
		...
		<tr>
			<th class="thEdit rt"><mc:msg key="sys0604.header.changePhoto"/></th>
			<td class="tdEdit" colspan="3"><ui:file name="photoPath" style="width:540px;" checkName="sys0604.header.changePhoto"/></td>
		</tr>
		<tr>
			<th class="thEdit rt"><mc:msg key="sys0604.header.userId"/></th>
			<td class="tdEdit"><ui:text name="userId" value="<%=sysUser.getUserId()%>" status="display"/></td>
			<th class="thEdit rt mandatory"><mc:msg key="sys0604.header.userName"/></th>
			<td class="tdEdit"><ui:text name="userName" value="<%=sysUser.getUserName()%>" checkName="sys0604.header.userName" options="mandatory"/></td>
		</tr>
		<tr>
			<th class="thEdit rt mandatory"><mc:msg key="sys0604.header.loginId"/></th>
			<td class="tdEdit"><ui:text name="loginId" value="<%=sysUser.getLoginId()%>" checkName="sys0604.header.loginId" options="mandatory"/></td>
			<th class="thEdit rt mandatory"><mc:msg key="sys0604.header.password"/></th>
			<td class="tdEdit"><ui:text name="password" value="<%=sysUser.getLoginPassword()%>" checkName="sys0604.header.password" options="mandatory"/></td>
		</tr>
		<tr>
			<th class="thEdit rt mandatory"><mc:msg key="sys0604.header.org"/></th>
			<td class="tdEdit">
				<ui:hidden name="orgId" value="<%=sysUser.getOrgId()%>" checkName="sys0604.header.org"/>
				<ui:text name="orgName" className="hor" style="width:250px" value="<%=DataHelper.getOrgNameById(sysUser.getOrgId())%>" checkName="sys0604.header.org" options="mandatory"/>
				<ui:icon id="icnOrgSearch" className="fa-search hor"/>
			</td>
			<th class="thEdit rt mandatory"><mc:msg key="sys0604.header.authGroup"/></th>
			<td class="tdEdit">
				<ui:select name="authGroup" checkName="sys0604.header.authGroup" options="mandatory">
<%
...
%>
		...
		<tr>
			<th class="thEdit rt mandatory"><mc:msg key="sys0604.header.language"/></th>
			<td class="tdEdit"><ui:ccselect name="language" codeType="LANGUAGE_TYPE" options="mandatory" selectedValue="<%=sysUser.getLanguage()%>"/></td>
			<th class="thEdit rt mandatory"><mc:msg key="sys0604.header.themeType"/></th>
		...
		<tr>
			<th class="thEdit rt mandatory"><mc:msg key="sys0604.header.type"/></th>
			<td class="tdEdit"><ui:ccselect name="userType" codeType="USER_TYPE" options="mandatory" selectedValue="<%=sysUser.getUserType()%>"/></td>
			<th class="thEdit rt mandatory"><mc:msg key="sys0604.header.email"/></th>
			<td class="tdEdit"><ui:text name="email" value="<%=sysUser.getEmail()%>" checkName="sys0604.header.email" options="mandatory" option="email"/></td>
		</tr>
		<tr>
			<th class="thEdit rt mandatory"><mc:msg key="sys0604.header.maxRowsPerPage"/></th>
			<td class="tdEdit">
				<ui:select name="maxRowsPerPage" checkName="sys0604.header.maxRowsPerPage" options="mandatory">
<%
...
%>
			...
			<th class="thEdit rt mandatory"><mc:msg key="sys0604.header.pageNumsPerPage"/></th>
			<td class="tdEdit">
				<ui:select name="pageNumsPerPage" checkName="sys0604.header.pageNumsPerPage" options="mandatory">
<%
...
%>
		...
		<tr>
			<th class="thEdit rt mandatory"><mc:msg key="sys0604.header.status"/></th>
