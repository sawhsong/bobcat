...
<div id="divDataArea" class="areaContainerPopup">
	<table class="tblEdit">
		...
		<tr>
			...
			<td class="tdEdit">
				<ui:ccselect name="orgCategory" codeType="ORG_CATEGORY" status="disabled" selectedValue="<%=orgCategory%>" checkName="sys0806.header.orgCategory" options="mandatory"/>
			</td>
		...
		<tr>
			...
			<td class="tdEdit">
				<ui:select name="mainExpenseType" checkName="sys0806.header.mainExpenseType" options="mandatory">
<%
...
%>
			...
			<th class="thEdit Rt"><mc:msg key="sys0806.header.expenseType"/></th>
			<td class="tdEdit">
				<ui:select name="expenseType" checkName="sys0806.header.expenseType">
...
%>
		...
		<tr>
			...
			<td class="tdEdit">
				<ui:text name="description" checkName="sys0806.header.description" options="mandatory"/>
			</td>
			<th class="thEdit Rt"><mc:msg key="sys0806.header.accountCode"/></th>
			<td class="tdEdit">
				<ui:text name="accountCode" checkName="sys0806.header.accountCode"/>
			</td>
		</tr>
		<tr>
			<th class="thEdit Rt mandatory"><mc:msg key="sys0806.header.isApplyGst"/></th>
			<td class="tdEdit">
				<ui:ccselect name="isApplyGst" codeType="SIMPLE_YN" selectedValue="N" checkName="sys0806.header.isApplyGst" options="mandatory"/>
			</td>
			<th class="thEdit Rt mandatory"><mc:msg key="sys0806.header.gstPercentage"/></th>
			<td class="tdEdit">
				<ui:text name="gstPercentage" className="numeric" checkName="sys0806.header.gstPercentage" options="mandatory"/>
			</td>
		</tr>
	</table>
</div>
