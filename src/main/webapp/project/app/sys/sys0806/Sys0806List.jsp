...
<div id="divButtonArea" class="areaContainer">
	...
	<div id="divButtonAreaRight">
		<ui:buttonGroup id="buttonGroup">
			<ui:button id="btnPreview" caption="sys0806.search.preview" iconClass="fa-eye-slash"/>
			<ui:button id="btnSetSort" caption="sys0806.search.setSort" iconClass="fa-sort-numeric-asc"/>
...
<div id="divSearchCriteriaArea" class="areaContainer">
	<table class="tblSearch">
		...
		<tr>
			<td class="tdSearch">
				<label for="orgCategory" class="lblEn hor mandatory"><mc:msg key="sys0806.search.orgCategory"/></label>
	...
	<table id="tblGrid" class="tblGrid sort autosort">
		...
		<thead>
			<tr>
				...
				<th class="thGrid"><mc:msg key="sys0806.grid.mainTypeName"/></th>
				<th class="thGrid"><mc:msg key="sys0806.grid.subTypeName"/></th>
				<th class="thGrid"><mc:msg key="sys0806.grid.isApplyGst"/></th>
				<th class="thGrid"><mc:msg key="sys0806.grid.gstPercentage"/></th>
				<th class="thGrid"><mc:msg key="sys0806.grid.accountCode"/></th>
				<th class="thGrid"><mc:msg key="sys0806.grid.sortOrder"/></th>
