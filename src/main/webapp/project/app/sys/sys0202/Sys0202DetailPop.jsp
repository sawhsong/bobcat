...
<div id="divInformArea" class="areaContainerPopup">
	<table class="tblEdit">
		...
		<tr>
			<th class="thEdit"><tag:msg key="sys0202.header.codeType"/></th>
			<td class="tdEdit"><%=resultDataSet.getValue(masterRow, "CODE_TYPE")%></td>
			<th class="thEdit"><tag:msg key="sys0202.header.isActive"/></th>
			<td class="tdEdit"><tag:radio name="rdoIsActiveMaster" codeType="SIMPLE_YN" selectedValue="<%=isActive%>" status="disabled"/></td>
		</tr>
		<tr>
			<th class="thEdit"><tag:msg key="sys0202.header.descriptionEn"/></th>
			<td class="tdEdit"><%=resultDataSet.getValue(masterRow, "DESCRIPTION_EN")%></td>
			<th class="thEdit"><tag:msg key="sys0202.header.descriptionKo"/></th>
...
%>
		<li class="codeDetail">
			<table class="tblEdit">
				...
				<tr>
					<th class="thEdit"><tag:msg key="sys0202.header.commonCode"/></th>
					<td class="tdEdit"><%=resultDataSet.getValue(i, "COMMON_CODE")%></td>
					<th class="thEdit"><tag:msg key="sys0202.header.isActive"/></th>
					<td class="tdEdit"><tag:radio name="<%=rdoIsActiveName%>" codeType="SIMPLE_YN" selectedValue="<%=isActive%>" status="disabled"/></td>
					<th class="thEdit"><tag:msg key="sys0202.header.sortOrder"/></th>
