...
<div id="divSearchCriteriaArea" class="areaContainer">
	<table class="tblSearch">
		...
		<tr>
			<td class="tdSearch">
				<label for="orgCategory" class="lblEn hor mandatory"><mc:msg key="sys0810.search.orgCategory"/></label>
	...
	<table id="tblGrid" class="tblGrid sort autosort">
		...
		<thead>
			<tr>
				...
				<th class="thGrid sortable:alphanumeric"><mc:msg key="sys0810.grid.repaymentType"/></th>
				<th class="thGrid"><mc:msg key="sys0810.grid.isApplyGst"/></th>
				<th class="thGrid"><mc:msg key="sys0810.grid.gstPercentage"/></th>
				<th class="thGrid"><mc:msg key="sys0810.grid.accountCode"/></th>
