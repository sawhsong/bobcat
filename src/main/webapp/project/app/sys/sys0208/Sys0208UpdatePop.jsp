...
<div id="divDataArea" class="areaContainerPopup">
	...
	<table class="tblEdit">
		...
		<tr>
			...
			<td class="tdEdit"><ui:text name="userName" value="<%=sysUser.getUserName()%>" checkName="sys0208.header.userName" options="mandatory"/></td>
		</tr>
		<tr>
			<th class="thEdit rt mandatory"><mc:msg key="sys0208.header.loginId"/></th>
			<td class="tdEdit"><ui:text name="loginId" value="<%=sysUser.getLoginId()%>" checkName="sys0208.header.loginId" options="mandatory"/></td>
			<th class="thEdit rt mandatory"><mc:msg key="sys0208.header.password"/></th>
			<td class="tdEdit"><ui:text name="password" value="<%=sysUser.getLoginPassword()%>" checkName="sys0208.header.password" options="mandatory"/></td>
		</tr>
		<tr>
			<th class="thEdit rt mandatory"><mc:msg key="sys0208.header.org"/></th>
			<td class="tdEdit">
				<ui:hidden name="orgId" value="<%=sysUser.getOrgId()%>" checkName="sys0208.header.org"/>
				<ui:text name="orgName" className="hor" style="width:250px" value="<%=DataHelper.getOrgNameById(sysUser.getOrgId())%>" checkName="sys0208.header.org" options="mandatory"/>
...
%>
		...
		<tr>
			...
			<td class="tdEdit"><ui:text name="email" value="<%=sysUser.getEmail()%>" checkName="sys0208.header.email" options="mandatory" option="email"/></td>
		</tr>
		<tr>
