...
<div id="divSearchCriteriaArea" class="areaContainer">
	<table class="tblSearch">
		...
		<tr>
			<th class="thSearch rt"><mc:msg key="sys0602.search.orgName"/></th>
			<td class="tdSearch"><ui:text name="orgName"/></td>
			<th class="thSearch rt"><mc:msg key="sys0602.search.abn"/></th>
			<td class="tdSearch"><ui:text name="abn"/></td>
			<th class="thSearch rt"><mc:msg key="sys0602.search.entityType"/></th>
			<td class="tdSearch"><ui:ccselect name="entityType" codeType="ENTITY_TYPE" caption="==Select=="/></td>
		</tr>
		<tr>
			<th class="thSearch rt"><mc:msg key="sys0602.search.bizType"/></th>
			<td class="tdSearch"><ui:ccselect name="businessType" codeType="BUSINESS_TYPE" caption="==Select=="/></td>
			<th class="thSearch rt"><mc:msg key="sys0602.search.orgCategory"/></th>
			<td class="tdSearch"><ui:ccselect name="orgCategory" codeType="ORG_CATEGORY" caption="==Select=="/></td>
			<th class="thSearch rt"><mc:msg key="sys0602.search.wageType"/></th>
	...
	<table id="tblGrid" class="tblGrid sort autosort">
		...
		<thead>
			<tr>
				...
				<th class="thGrid sortable:alphanumeric"><mc:msg key="sys0602.grid.legalName"/></th>
				<th class="thGrid sortable:alphanumeric"><mc:msg key="sys0602.grid.tradingName"/></th>
				<th class="thGrid"><mc:msg key="sys0602.grid.abn"/></th>
				<th class="thGrid"><mc:msg key="sys0602.grid.users"/></th>
				<th class="thGrid sortable:alphanumeric"><mc:msg key="sys0602.grid.entityType"/></th>
				<th class="thGrid sortable:alphanumeric"><mc:msg key="sys0602.grid.bizType"/></th>
				<th class="thGrid sortable:alphanumeric"><mc:msg key="sys0602.grid.orgCategory"/></th>
				<th class="thGrid sortable:alphanumeric"><mc:msg key="sys0602.grid.wageType"/></th>
				<th class="thGrid"><mc:msg key="sys0602.grid.revRangeFrom"/></th>
				<th class="thGrid"><mc:msg key="sys0602.grid.revRangeTo"/></th>
				<th class="thGrid sortable:date"><mc:msg key="sys0602.grid.regDate"/></th>
