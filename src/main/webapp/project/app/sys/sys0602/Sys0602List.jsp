<%/************************************************************************************************
* Description - Sys0602 - Annoucement
...
$(function() {
	...
	openPopup = function(param) {
		...
		if (param.mode == "Detail") {
			...
			header = "<tag:msg key="sys0602.header.popupHeaderDetail"/>";
		} else if (param.mode == "New" || param.mode == "Reply") {
			url = "/sys/0602/getInsert.do";
			header = "<tag:msg key="sys0602.header.popupHeaderEdit"/>";
...
<div id="divSearchCriteriaArea" class="areaContainer">
	<table class="tblSearch">
		...
		<tr>
			<td class="tdSearch">
				<label for="searchType" class="lblEn hor"><tag:msg key="sys0602.search.searchType"/></label>
			...
			<td class="tdSearch">
				<label for="fromDate" class="lblEn hor"><tag:msg key="sys0602.search.searchPeriod"/></label>
				<input type="text" id="fromDate" name="fromDate" class="txtEnCt hor" style="width:100px" checkName="<tag:msg key="sys0602.search.searchDateFrom"/>" option="date"/>
				<i id="icnFromDate" class="fa fa-calendar icnEn hor" title="<tag:msg key="sys0602.search.searchDateFrom"/>"></i>
				<div class="horGap20" style="padding:6px 8px 6px 0px;">-</div>
				<input type="text" id="toDate" name="toDate" class="txtEnCt hor" style="width:100px" checkName="<tag:msg key="sys0602.search.searchDateTo"/>" option="date"/>
				<i id="icnToDate" class="fa fa-calendar icnEn hor" title="<tag:msg key="sys0602.search.searchDateTo"/>"></i>
			</td>
		</tr>
	</table>
</div>
	...
	<table id="tblGrid" class="tblGrid sort autosort">
		...
		<thead>
			<tr class="noBorderHor">
				...
				<th class="thGrid sortable:alphanumeric"><tag:msg key="sys0602.grid.subject"/></th>
				<th class="thGrid"><tag:msg key="sys0602.grid.file"/></th>
				<th class="thGrid sortable:alphanumeric"><tag:msg key="sys0602.grid.writerName"/></th>
				<th class="thGrid sortable:date"><tag:msg key="sys0602.grid.insertDate"/></th>
				<th class="thGrid sortable:date"><tag:msg key="sys0602.grid.updateDate"/></th>
				<th class="thGrid sortable:numeric"><tag:msg key="sys0602.grid.hitCount"/></th>
