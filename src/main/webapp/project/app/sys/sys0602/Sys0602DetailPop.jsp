...
<div id="divDataArea" class="areaContainerPopup">
	<table class="tblEdit">
		...
		<tr>
			<th class="thEditRt"><tag:msg key="sys0602.header.writerName"/></th>
			<td class="tdEdit"><%=noticeBoard.getWriterName()%>(<%=noticeBoard.getWriterId()%>)</td>
			<th class="thEditRt"><tag:msg key="sys0602.header.writerEmail"/></th>
			<td class="tdEdit"><%=noticeBoard.getWriterEmail()%></td>
		</tr>
		<tr>
			<th class="thEditRt"><tag:msg key="sys0602.header.updateDate"/></th>
			<td class="tdEdit"><%=CommonUtil.toViewDateString(noticeBoard.getUpdateDate())%></td>
			<th class="thEditRt"><tag:msg key="sys0602.header.hitCount"/></th>
			<td class="tdEdit"><%=CommonUtil.getNumberMask(noticeBoard.getHitCnt())%></td>
		</tr>
		<tr>
			<th class="thEditRt"><tag:msg key="sys0602.header.articleSubject"/></th>
		...
		<tr>
			<th class="thEditRt"><tag:msg key="sys0602.header.attachedFile"/></th>
