...
$(function() {
	...
	doProcessByButton = function(param) {
		...
		var action = "", userId = "<%=userId%>", writerId = "<%=sysBoard.getWriterId()%>";

		if (param.mode == "Update" || param.mode == "Delete") {
			if (userId != writerId) {
				commonJs.openDialog({
					type:"warning",
...
<div id="divDataArea" class="areaContainer">
	<table class="tblEdit">
		...
		<tr>
			<th class="thEdit"><tag:msg key="bbs0204.header.writerName"/></th>
			<td class="tdEdit"><%=sysBoard.getWriterName()%>(<%=sysBoard.getWriterId()%>)</td>
			<th class="thEdit"><tag:msg key="bbs0204.header.writerEmail"/></th>
			<td class="tdEdit"><%=sysBoard.getWriterEmail()%></td>
		</tr>
		<tr>
			<th class="thEdit"><tag:msg key="bbs0204.header.updateDate"/></th>
			<td class="tdEdit"><%=CommonUtil.toViewDateString(sysBoard.getUpdateDate())%></td>
			<th class="thEdit"><tag:msg key="bbs0204.header.hitCount"/></th>
			<td class="tdEdit"><%=CommonUtil.getNumberMask(sysBoard.getHitCnt())%></td>
		</tr>
		<tr>
			<th class="thEdit"><tag:msg key="bbs0204.header.articleSubject"/></th>
			<td class="tdEdit" colspan="3"><%=sysBoard.getArticleSubject()%></td>
		</tr>
		<tr>
			<th class="thEdit"><tag:msg key="bbs0204.header.attachedFile"/></th>
