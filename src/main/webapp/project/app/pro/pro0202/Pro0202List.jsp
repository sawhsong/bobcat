...
<div id="divDataArea" class="areaContainer">
	<div id="divPayrollSummary" style="float:left;width:50%;">
		<table id="tblPayrollSummary" class="tblGrid sort autosort">
			<colgroup>
				<col width="3%"/>
				<col width="34%"/>
				<col width="*"/>
	...
	<div id="divPayrollLink" style="float:right;width:49%;">
	</div>
</div>
<%/************************************************************************************************
* Right & Footer
