...
$(function() {
	...
	openPopup = function(param) {
		...
		if (param.mode == "Detail") {
			...
			header = "<tag:msg key="odd0202.header.popupHeaderDetail"/>";
		} else if (param.mode == "New" || param.mode == "Reply") {
			url = "/odd/0202/getInsert.do";
			header = "<tag:msg key="odd0202.header.popupHeaderEdit"/>";
	...
	getAttachedFile = function(img) {
		commonJs.ajaxSubmit({
			url:"/odd/0202/getAttachedFile.do",
			dataType:"json",
			data:{
	...
	<div class="panel panel-default">
		<div class="panel-body">
			<table class="tblDefault">
				...
				<tr>
					<td class="tdDefault">
						<label for="searchType" class="lblEn hor"><tag:msg key="odd0202.search.searchType"/></label>
					...
					<td class="tdDefault">
						<label for="fromDate" class="lblEn hor"><tag:msg key="odd0202.search.searchPeriod"/></label>
						<input type="text" id="fromDate" name="fromDate" class="txtEnCt hor" style="width:100px" checkName="<tag:msg key="odd0202.search.searchDateFrom"/>" option="date"/>
						<i id="icnFromDate" class="fa fa-calendar icnEn hor" title="<tag:msg key="odd0202.search.searchDateFrom"/>"></i>
						<div class="horGap20" style="padding:6px 8px 6px 0px;">-</div>
						<input type="text" id="toDate" name="toDate" class="txtEnCt hor" style="width:100px" checkName="<tag:msg key="odd0202.search.searchDateTo"/>" option="date"/>
						<i id="icnToDate" class="fa fa-calendar icnEn hor" title="<tag:msg key="odd0202.search.searchDateTo"/>"></i>
					</td>
				</tr>
			</table>
		</div>
	...
	<table id="tblGrid" class="tblGrid sort autosort">
		...
		<thead>
			<tr class="noBorderHor">
				...
				<th class="thGrid sortable:alphanumeric"><tag:msg key="odd0202.grid.subject"/></th>
				<th class="thGrid"><tag:msg key="odd0202.grid.file"/></th>
				<th class="thGrid sortable:alphanumeric"><tag:msg key="odd0202.grid.writerName"/></th>
				<th class="thGrid sortable:date"><tag:msg key="odd0202.grid.date"/></th>
				<th class="thGrid sortable:numeric"><tag:msg key="odd0202.grid.hitCount"/></th>
