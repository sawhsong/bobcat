	...
	renderDataGridTable = function(result) {
		...
		if (ds.getRowCnt() > 0) {
			for (var i=0; i<ds.getRowCnt(); i++) {
				...
				uiAnc.setText(ds.getValue(i, "INCOME_TYPE_NAME")).setScript("getDetail('"+ds.getValue(i, "INCOME_TYPE_ID")+"', '"+ds.getValue(i, "INCOME_TYPE_CODE")+"')");
