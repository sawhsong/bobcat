...
public class Rkm0804Action extends BaseAction {
	@Autowired
	private Rkm0804Biz biz;
	...
	public String getEmployeeList() throws Exception {
		try {
			biz.getEmployeeList(paramEntity);
		} catch (Exception ex) {
		}
	...
	public String getWageList() throws Exception {
		try {
			biz.getWageList(paramEntity);
		} catch (Exception ex) {
		}
		setRequestAttribute("paramEntity", paramEntity);
		return "ajaxResponse";
