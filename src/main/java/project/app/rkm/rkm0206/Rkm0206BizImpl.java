...
public class Rkm0206BizImpl extends BaseBiz implements Rkm0206Biz {
	...
	public ParamEntity exeSave(ParamEntity paramEntity) throws Exception {
		...
		try {
			...
			usrIncome.setIncomeEntryType(CommonCodeManager.getCodeByConstants("INCOME_ENTRY_TYPE_OTHETC"));
			...
			usrIncome.setIncomeTypeId(dsReq.getValue("deIncomeType"));
	...
	public ParamEntity exeExport(ParamEntity paramEntity) throws Exception {
		...
		try {
			...
			columnHeader = new String[] {"INCOME_DATE", "GROSS_AMT", "GST_AMT", "NET_AMT", "INCOME_TYPE_DESC", "IS_COMPLETED", "DESCRIPTION"};
			fileHeader = new String[] {"Date", "Gross Sales", "GST", "Net Sales", "Income Type", "Is Completed", "Description"};
