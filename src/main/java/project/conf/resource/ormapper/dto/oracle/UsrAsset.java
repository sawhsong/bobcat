...
public class UsrAsset extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public UsrAsset() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("ASSET_ID");
		setFrwVarDateColumn("ASSET_DATE,INSERT_DATE,UPDATE_DATE");
	...
	public void setAssetId(String assetId) throws Exception {
		this.assetId = assetId;
		setValueFromAccessor("ASSET_ID", assetId);
	}
	...
	public void setAssetDate(Date assetDate) throws Exception {
		this.assetDate = assetDate;
		setValueFromAccessor("ASSET_DATE", CommonUtil.toString(assetDate));
	}
	...
	public void setAssetTypeId(String assetTypeId) throws Exception {
		this.assetTypeId = assetTypeId;
		setValueFromAccessor("ASSET_TYPE_ID", assetTypeId);
	}
	...
	public void setAssetYear(String assetYear) throws Exception {
		this.assetYear = assetYear;
		setValueFromAccessor("ASSET_YEAR", assetYear);
	}
	...
	public String toString() {
		...
		str += "assetId : "+assetId+"\n";
		str += "assetDate : "+assetDate+"\n";
		str += "assetTypeId : "+assetTypeId+"\n";
		str += "assetYear : "+assetYear+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"assetId\" value=\""+assetId+"\">";
		str += "<column name=\"assetDate\" value=\""+assetDate+"\">";
		str += "<column name=\"assetTypeId\" value=\""+assetTypeId+"\">";
		str += "<column name=\"assetYear\" value=\""+assetYear+"\">";
