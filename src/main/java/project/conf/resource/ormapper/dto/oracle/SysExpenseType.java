...
public class SysExpenseType extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	private String PARENT_EXPENSE_TYPE;
	...
	public SysExpenseType() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("EXPENSE_TYPE_ID");
	...
	public void setParentExpenseType(String parentExpenseType) throws Exception {
		this.parentExpenseType = parentExpenseType;
		setValueFromAccessor("PARENT_EXPENSE_TYPE", parentExpenseType);
	}
	...
	public String toString() {
		...
		str += "parentExpenseType : "+parentExpenseType+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"parentExpenseType\" value=\""+parentExpenseType+"\">";
