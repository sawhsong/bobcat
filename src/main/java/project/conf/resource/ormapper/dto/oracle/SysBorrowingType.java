...
public class SysBorrowingType extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	private String borrowingTypeId;
	private String BORROWING_TYPE_ID;
	private String borrowingType;
	private String BORROWING_TYPE;
	...
	private String parentBorrowingType;
	private String PARENT_BORROWING_TYPE;
	...
	public SysBorrowingType() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("BORROWING_TYPE_ID");
	 ...
	 * Accessors
	 */
	public String getBorrowingTypeId() {
		return borrowingTypeId;
	}

	public void setBorrowingTypeId(String borrowingTypeId) throws Exception {
		this.borrowingTypeId = borrowingTypeId;
		setValueFromAccessor("BORROWING_TYPE_ID", borrowingTypeId);
	}
	...
	public void setBorrowingType(String borrowingType) throws Exception {
		this.borrowingType = borrowingType;
		setValueFromAccessor("BORROWING_TYPE", borrowingType);
	}
	...
	public String getParentBorrowingType() {
		return parentBorrowingType;
	}

	public void setParentBorrowingType(String parentBorrowingType) throws Exception {
		this.parentBorrowingType = parentBorrowingType;
		setValueFromAccessor("PARENT_BORROWING_TYPE", parentBorrowingType);
	}
	...
	public String toString() {
		...
		str += "borrowingTypeId : "+borrowingTypeId+"\n";
		str += "borrowingType : "+borrowingType+"\n";
		...
		str += "parentBorrowingType : "+parentBorrowingType+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"borrowingTypeId\" value=\""+borrowingTypeId+"\">";
		str += "<column name=\"borrowingType\" value=\""+borrowingType+"\">";
		...
		str += "<column name=\"parentBorrowingType\" value=\""+parentBorrowingType+"\">";
