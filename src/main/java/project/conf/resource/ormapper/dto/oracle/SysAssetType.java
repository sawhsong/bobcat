...
public class SysAssetType extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	private String PARENT_ASSET_TYPE;
	...
	public SysAssetType() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("ASSET_TYPE_ID");
	...
	public void setAssetType(String assetType) throws Exception {
		...
		setValueFromAccessor("ASSET_TYPE", assetType);
	}
	...
	public void setParentAssetType(String parentAssetType) throws Exception {
		this.parentAssetType = parentAssetType;
		setValueFromAccessor("PARENT_ASSET_TYPE", parentAssetType);
	}
	...
	public String toString() {
		...
		str += "parentAssetType : "+parentAssetType+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"assetType\" value=\""+assetType+"\">";
		...
		str += "<column name=\"parentAssetType\" value=\""+parentAssetType+"\">";
