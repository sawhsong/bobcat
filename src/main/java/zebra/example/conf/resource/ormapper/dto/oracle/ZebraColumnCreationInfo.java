 ...
 * - ZEBRA_COLUMN_CREATION_INFO - Column info to be created
 *************************************************************************************************/
...
public class ZebraColumnCreationInfo extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	private String FK_TABLE_COLUMN;
	...
	public ZebraColumnCreationInfo() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("COLUMN_NAME,TABLE_NAME");
		setFrwVarDateColumn("INSERT_DATE,UPDATE_DATE");
		setFrwVarNumberColumn("DATA_LENGTH");
		setFrwVarClobColumn("");
		setFrwVarDefaultColumn("INSERT_DATE,NULLABLE");
		setFrwVarDefaultValue("sysdate,Y");
		setDefaultValue();
	}
	...
	public void setColumnName(String columnName) throws Exception {
		...
		setValueFromAccessor("COLUMN_NAME", columnName);
	}
	...
	public void setTableName(String tableName) throws Exception {
		...
		setValueFromAccessor("TABLE_NAME", tableName);
	}
	...
	public void setFkTableColumn(String fkTableColumn) throws Exception {
		this.fkTableColumn = fkTableColumn;
		setValueFromAccessor("FK_TABLE_COLUMN", fkTableColumn);
	}
	...
	public void setKeyType(String keyType) throws Exception {
		this.keyType = keyType;
		setValueFromAccessor("KEY_TYPE", keyType);
	}
	...
	public void setNullable(String nullable) throws Exception {
		this.nullable = nullable;
		setValueFromAccessor("NULLABLE", nullable);
	}
	...
	public boolean equals(Object object) {
		if (!(object instanceof ZebraColumnCreationInfo)) {
			return false;
		}
		return true;
	}
	...
	public String toString() {
		...
		str += "fkTableColumn : "+fkTableColumn+"\n";
	...
	public String toXmlString() {
		...
		str += "<column name=\"columnName\" value=\""+columnName+"\">";
		str += "<column name=\"tableName\" value=\""+tableName+"\">";
		...
		str += "<column name=\"fkTableColumn\" value=\""+fkTableColumn+"\">";
		str += "<column name=\"insertDate\" value=\""+insertDate+"\">";
		str += "<column name=\"insertUserId\" value=\""+insertUserId+"\">";
		str += "<column name=\"keyType\" value=\""+keyType+"\">";
		str += "<column name=\"nullable\" value=\""+nullable+"\">";
