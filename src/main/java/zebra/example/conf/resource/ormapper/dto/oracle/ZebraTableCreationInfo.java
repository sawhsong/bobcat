...
public class ZebraTableCreationInfo extends BaseDto implements Serializable {
	/**
	 * Columns
	 */
	...
	public ZebraTableCreationInfo() throws Exception {
		Class cls = getClass();
		...
		setFrwVarPrimaryKey("TABLE_NAME");
		setFrwVarDateColumn("INSERT_DATE,UPDATE_DATE");
		setFrwVarNumberColumn("");
		setFrwVarClobColumn("SQL_SCRIPT");
		setFrwVarDefaultColumn("INSERT_DATE,SQL_SCRIPT");
		setFrwVarDefaultValue("sysdate,EMPTY_CLOB()");
		setDefaultValue();
	}
	...
	public void setFilePathName(String filePathName) throws Exception {
		this.filePathName = filePathName;
		setValueFromAccessor("FILE_PATH_NAME", filePathName);
	}
	...
	public void setSqlScript(String sqlScript) throws Exception {
		this.sqlScript = sqlScript;
		setValueFromAccessor("SQL_SCRIPT", sqlScript);
	}
