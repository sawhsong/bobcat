...
public class Sba0406BizImpl extends BaseBiz implements Sba0406Biz {
	...
	public ParamEntity getMainType(ParamEntity paramEntity) throws Exception {
		...
		try {
			...
			paramEntity.setAjaxResponseDataSet(sysExpenseTypeDao.getMainTypeDataSetByCriteria(queryAdvisor));
			paramEntity.setSuccess(true);
		} catch (Exception ex) {
			throw new FrameworkException(paramEntity, ex);
		}
	...
	public ParamEntity getSubType(ParamEntity paramEntity) throws Exception {
		DataSet requestDataSet = paramEntity.getRequestDataSet();
		HttpSession session = paramEntity.getSession();
		QueryAdvisor queryAdvisor = paramEntity.getQueryAdvisor();
		...
		try {
			...
			paramEntity.setAjaxResponseDataSet(sysExpenseTypeDao.getSubTypeDataSetByCriteria(queryAdvisor));
			paramEntity.setSuccess(true);
		} catch (Exception ex) {
			throw new FrameworkException(paramEntity, ex);
		}
...
/*
	...
	public ParamEntity exeInsert(ParamEntity paramEntity) throws Exception {
		...
		try {
			...
			sysBoard.setArticleContents(HtmlUtil.special2htm(requestDataSet.getValue("articleContents"), "\n"));
