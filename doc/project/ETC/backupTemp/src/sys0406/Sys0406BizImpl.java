...
public class Sys0406BizImpl extends BaseBiz implements Sys0406Biz {
	...
	public ParamEntity getDefault(ParamEntity paramEntity) throws Exception {
		...
		try {
			...
			paramEntity.setObject("resultDataSet", sysUserDao.getUserDataSetBySearchCriteria(queryAdvisor));
	...
	public ParamEntity exeExport(ParamEntity paramEntity) throws Exception {
		...
		try {
			...
			String[] columnHeader = {"user_id", "user_name", "login_id", "person_id", "auth_group_name", "user_type", "user_status", "email", "is_active", "update_date"};
