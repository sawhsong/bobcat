...
<div id="divDataArea" class="areaContainerPopup">
	...
	<table class="tblEdit">
		...
		<tr>
			...
			<th class="thEdit"><tag:msg key="sys0406.header.userName"/></th>
			<td class="tdEdit"><%=sysUser.getUserName()%></td>
		</tr>
		<tr>
			<th class="thEdit"><tag:msg key="sys0406.header.loginId"/></th>
		...
		<tr>
			...
			<td class="tdEdit"><%=sysUser.getPersonId()%></td>
