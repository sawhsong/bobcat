...
create table sys_board_file (
    ...
    file_type                       varchar2(300)                                not null,      -- File type
    file_icon                       varchar2(1000)                               not null,      -- File Icon path and name
    ...
    constraint fk_1196321927451218 foreign key(article_id) references sys_board(article_id),
    constraint pk_sys_board_file primary key(file_id),
    constraint uk_1196321950836096 unique(file_type, file_icon)
